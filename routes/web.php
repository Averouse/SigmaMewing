...
Route::get('/hosw', function () {
    return view('hosw'); // Pastikan file view dashboard.blade.php ada di folder resources/views
});

Route::get('/celana', function () {
    return view('celana'); // Pastikan file view dashboard.blade.php ada di folder resources/views
});

Route::get('/aksesoris', function () {
    return view('aksesoris'); // Pastikan file view dashboard.blade.php ada di folder resources/views
});
